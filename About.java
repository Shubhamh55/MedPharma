...
class About extends JFrame
{
	...
	About()
	{
		...
		l3 = new JLabel("Mr. Aniket Bichare");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,200,400,40);l3.setForeground(Color.red);
		jf.add(l3);
		

		l3 = new JLabel("Mr. Ajinkya Deshmukh.");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,220,400,40);l3.setForeground(Color.red);
		jf.add(l3);
		

		l3 = new JLabel("Mr. Sachin Gajalwad");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,240,400,40);l3.setForeground(Color.red);
		jf.add(l3);
		

		l3 = new JLabel("Mr. Kiran Gunjal");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,260,400,40);l3.setForeground(Color.red);
		jf.add(l3);
		

		l3 = new JLabel("Mr. Shubham Hingade.");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,280,400,40);l3.setForeground(Color.red);
		jf.add(l3);

		l2 = new JLabel("Under the guidance of");
		//l2.setFont(new Font("Times New Roman",Font.BOLD,20));
		l2.setBounds(100,310,800,40);
		jf.add(l2);
		
		l4 = new JLabel("Mrs.Deepali Salapurkar Mam.");
		l4.setFont(new Font("Times New Roman",Font.BOLD,18));l4.setForeground(Color.red);
		l4.setBounds(300,330,400,40);
		jf.add(l4);

		l5 = new JLabel("In this system we can add details of Medicines,Suppliers.");
		//l5.setFont(new Font("Times New Roman",Font.BOLD,20));
		l5.setBounds(100,400,800,40);
		jf.add(l5);

		l6 = new JLabel("We can also upadte,delete & search the existing details.");
		//l6.setFont(new Font("Times New Roman",Font.BOLD,20));
		l6.setBounds(100,420,800,40);
		jf.add(l6);
